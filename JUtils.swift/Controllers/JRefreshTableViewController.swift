...
open class JRefreshTableViewController<E: JEntity, Type, D: JDataModel<E, Type>>: UIViewController, JRefreshTableViewControllerProtocol, UITableViewDelegate, UITableViewDataSource {
